...
// This is the interface used by the rendering engine to render all objects in the group.
...
// {
//   public:
//     // Models must specify an object type that represents a single instance of this model.
//     using SceneObjectType;
//
//     // Renders the group of objects from the viewpoint of the passed in camera.
...
public:
    ...
    // SceneObjectGroup is constructed from the arguments for its model. The model is created on
    // construction from the arguments.
    ...
    // TODO: Maybe this should take arguments, that it should forward to the constructor of the
    // SceneObjectType?
