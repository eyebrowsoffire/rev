...
using PhysicsComponents =
    UnitComponentEnumeration<DistanceComponent, TimeComponent, MassComponent>;

using DistanceComposition =
    PhysicsComponents::MakeComposition<DistanceComponent>;
...
using VelocityComposition =
    MultiplyComposition<DistanceComposition,
                        InvertComposition<TimeComposition>>;
using AccelerationComposition =
    MultiplyComposition<VelocityComposition,
                        InvertComposition<TimeComposition>>;
using MomentumComposition =
    MultiplyComposition<VelocityComposition, MassComposition>;
using ForceComposition =
    MultiplyComposition<MassComposition, AccelerationComposition>;

template <typename ValueType>
using Distance = Unit<ValueType, DistanceComposition>;

template <typename ValueType> using Time = Unit<ValueType, TimeComposition>;

template <typename ValueType> using Mass = Unit<ValueType, MassComposition>;
...
template <typename ValueType> using Force = Unit<ValueType, ForceComposition>;
