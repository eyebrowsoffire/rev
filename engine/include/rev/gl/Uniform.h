...
template <typename VariableType> class Uniform {
public:
  Uniform() : _location(-1) {}

  Uniform(GLint location) : _location(location) {}

  void set(const VariableType &value) { setUniform(_location, value); }
...
private:
  ...
  void setUniform(GLint location, GLint value) { glUniform1i(location, value); }
