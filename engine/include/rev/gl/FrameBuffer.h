...
using FrameBuffer = Resource<singleCreate<glGenFramebuffers>, singleDestroy<glDeleteFramebuffers>>;
    ...
    : public ResourceContext<FrameBuffer, enumTargetBindFunction<glBindFramebuffer, Target>>
{
  public:
    ...
    {
        GLint result;
        glGetFramebufferAttachmentParameteriv(Target, attachment, parameterName, &result);
        return result;
    }
};
