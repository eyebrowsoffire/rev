...
template <typename... Attachments> class RenderStage {
public:
  RenderStage() {
  ...
  template <typename RenderProperty> const Texture &getOutputTexture() const {
...
private:
  ...
  template <typename RenderStageAttachment> class AttachmentTexture {
  public:
