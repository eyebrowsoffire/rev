...
Camera::Camera()
    : _position(0.0f), _target(0.0, 0.0, -1.0), _upVector(0.0, 1.0, 0.0),
      _nearClip(0.1f), _farClip(100.0f), _fov(glm::half_pi<float>()),
      _aspect(16.0 / 9.0), _viewDirty(true), _projectionDirty(true) {}
