...
using TestComponentEnumeration =
    UnitComponentEnumeration<TestComponent1, TestComponent2, TestComponent3>;
...
using TestUnitComp3_1x1 =
    MultiplyComposition<TestUnitComp3, InvertComposition<TestUnitComp1x1>>;

static_assert(
    std::is_same_v<TestUnitComp3,
                   MultiplyComposition<TestUnitComp3_1x1, TestUnitComp1x1>>);

template <typename ValueType> using TestUnit1 = Unit<ValueType, TestUnitComp1>;

template <typename ValueType> using TestUnit2 = Unit<ValueType, TestUnitComp2>;

template <typename ValueType> using TestUnit3 = Unit<ValueType, TestUnitComp3>;
